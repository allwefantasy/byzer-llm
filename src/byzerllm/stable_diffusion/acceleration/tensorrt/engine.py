import gc
import os
from byzerllm.stable_diffusion.api.models.tensorrt import (
    BuildEngineOptions,
    TensorRTEngineData,
)
...
from byzerllm.stable_diffusion.lib.tensorrt.utilities import (
    build_engine,
    create_models,
    export_onnx,
    optimize_onnx,
)
from byzerllm.stable_diffusion.diffusion.utils import (
    load_text_encoder,
    load_unet,
    load_vae_decoder,
    load_vae_encoder,
...
class EngineBuilder:
    def __init__(self, model: DiffusersModel, opts: BuildEngineOptions):
        self.model = model
        self.device = "cuda"
        self.opts = opts
